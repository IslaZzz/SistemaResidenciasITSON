...
public class FrmRegistrarActividadLimpieza extends JFrameBase {
        ...
        private void configurarRangoFechas() {
                ...
                datePicker1.getSettings().setVetoPolicy(new DateVetoPolicy() {
                        ...
                        public boolean isDateAllowed(LocalDate date) {
                                ...
                                LocalTime horaLimite = LocalTime.of(19, 0); // 7:00 PM

                                // Si es después de las 19:00, vetar el día actual
                                if (date.equals(hoy) && horaActual.isAfter(horaLimite)) {
                                        return false;
                                }
        ...
        private void configurarRangoHoras() {
                ...
                settings.setVetoPolicy(new TimeVetoPolicy() {
                        ...
                        public boolean isTimeAllowed(LocalTime time) {
                                // Permitir solo horas entre las 7:00 AM y las 19:00 PM
                                LocalTime inicio = LocalTime.of(7, 0);
                                LocalTime fin = LocalTime.of(19, 0);

                                // Si es hoy, solo permitir horas posteriores a la actual
                                if (datePicker1.getDate() != null && datePicker1.getDate().equals(LocalDate.now())) {
                                        return !time.isBefore(inicio) && !time.isAfter(fin)
                                                        && !time.isBefore(LocalTime.now());
                                }

                                // Para fechas futuras, permitir cualquier hora dentro del rango
                                return !time.isBefore(inicio) && !time.isAfter(fin);
                        }
                });
        }
        ...
        private void btnRegistrarNuevaActividadActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnRegistrarNuevaActividadActionPerformed
                ...
                int confirmacion = JOptionPane.showConfirmDialog(this,
                                "¿Está seguro de que desea registrar la actividad?",
                ...
                if (confirmacion == JOptionPane.YES_OPTION) {
                        ...
                        ActividadLimpiezaDTO actividad = new ActividadLimpiezaDTO(zona, personal, fechaHoraActividad,
                        ...
                        try {
                                ...
                                JOptionPane.showMessageDialog(this,
                                                "Error al registrar la actividad: " + e.getMessage(), "Error",
                                                JOptionPane.ERROR_MESSAGE);
                                return;
                        }
